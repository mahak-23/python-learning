...
- [Ch-5/five.py](Ch-5/five.py) — Dictionaries, sets, and data structure operations
- [Ch-6/six.py](Ch-6/six.py) — Conditional statements, if-else logic, and operators

#### **Control & Functions (Ch 7-8): Logic Flow**  
- [Ch-7/seven.py](Ch-7/seven.py) — Loops (while/for), range(), break, continue, pass
- [Ch-8/eight.py](Ch-8/eight.py) — Functions, recursion, and code organization

#### **File Operations & OOP (Ch 9-11): Intermediate Skills**
- [Ch-9/nine.py](Ch-9/nine.py) — File I/O, reading/writing files, directory operations
- [Ch-10/ten.py](Ch-10/ten.py) — Object-oriented programming, classes, and objects  
- [Ch-11/eleven.py](Ch-11/eleven.py) — Inheritance, polymorphism, operator overloading
